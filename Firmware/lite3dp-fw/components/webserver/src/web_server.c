...
static const char *WEB_UI_HTML =
    ...
    "</div>"
    "<div style='margin-top:10px'>"
    "<button class='btn' onclick='ctl(\"/api/uv\",{duty:128,seconds:3,mask:true})'>"
    "UV Test 3s (white mask)</button>"
    "<button class='btn' onclick='ctl(\"/api/uv\",{duty:128,seconds:3,mask:false})'>"
    "UV Only (mask closed)</button>"
